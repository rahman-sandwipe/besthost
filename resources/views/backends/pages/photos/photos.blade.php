...
@section('title')
<title>Photos List :: Newscripts</title>
@endsection
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">                        
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Photo</h2>
                    <ul class="breadcrumb">
                ...
                <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                    <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                        <a href="{{ route('create.photo') }}" class="btn btn-primary">Add New</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions" style="width: 15%">
                                            <p class="demo-button">
                                                @if ($item->status=='active')
                                                <a href="{{ route('status.photo',$item->id) }}" class="btn btn-danger" title="Active"><i class="fa fa-eye-slash"></i></a>
                                                @else
                                                <a href="{{ route('status.photo',$item->id) }}" class="btn btn-success" title="Inactive"><i class="fa fa-eye"></i></a>
                                                @endif
                                                ...
                                                <a href="{{ route('edit.photo',$item->id) }}" class="btn btn-success" title="edit"><span class="sr-only">edit</span> <i class="fa fa-edit"></i></a>
                                                <a href="{{ route('delete.photo',$item->id) }}" class="btn btn-danger" title="Delete"><span class="sr-only">Delete</span> <i class="fa fa-trash-o"></i></a>
                                            </p>
                                        </td>
                                    </tr>
